...
int RBTree::find(int data)
{
    Node*temp=Find(root,data);
    return temp==nullptr?NULL:temp->data;
}
Node* RBTree::Find(Node *&_root, int data)
{
    if (_root==nullptr)return nullptr;
    if (_root->data==data)return _root;
    if (_root->data>data)return Find(_root->left,data);
    if (_root->data<data)return Find(_root->right,data);
